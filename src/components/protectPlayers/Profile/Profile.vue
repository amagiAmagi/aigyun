  ...
  <div class="Profile">
    ...
    <div class="left">
      <div class="logo-player">
        <img src="../../../assets/logo-player.png" alt="">
      </div>
      <div class="belong">
        值保队隶属于：深圳高科新农
      </div>
    ...
    <div class="institution">
      <span class="organization">姓名：</span><input type="text" v-model="name">
    </div>
    <div class="institution">
     ...
     <div class="institution">
      <span class="organization">身份证号：</span><input type="text" v-model="names">
    </div>
    <div class="institution">
    ...
    <el-input type="textarea" :autosize="{ minRows: 2, maxRows: 2}" placeholder="请输入内容" class="textarea">
    </el-input>
    ...
    <div class="institution">
      <span class="organization">飞手证：</span>
      <el-radio v-model="radios" label="1">有</el-radio>
      <el-radio v-model="radios" label="2">没有</el-radio>
    </div>
    <div class="Logo">
    ...
    <div class="buttonfortsr">
      ...
      <el-button type="primary" class="approve" @click="approve">确定</el-button>
...
<script>
import "./Profile.css";
import cityLinke from "../../business/modified/city/cityLinkage";
