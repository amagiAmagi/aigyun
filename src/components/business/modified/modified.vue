...
<div>
  <div class="modified">
    ...
    <div class="institution">
      <span class="organization">机构：</span><input type="text" v-model="name">
    </div>
    <div class="institution">
      <span class="organization">联系人：</span><input type="text" v-model="names">
    </div>
    <div class="institution">
    ...
    <el-input type="textarea" :autosize="{ minRows: 2, maxRows: 2}" placeholder="请输入内容" class="textarea" v-model="textarea">
    </el-input>

    <div class="institution">
      <span class="organization">服务电话：</span><input type="text" placeholder="请输入电话号码" v-model="phone">
    </div>
    <div class="ihpone">
      <span class="organization">手机：</span><input type="text" v-model="phones">
      <div class="chasger" @click="changeipgone"><span class="el-icon-sort change"></span></div>
    </div>
    <div class="ihpone">
      <span class="organization">邮箱：</span><input type="text" v-model="elimr">
      <div class="chasger" @click="changeipgones"><span class="el-icon-sort change"></span></div>
    </div>

    <div class="Logo">
      <span class="organization">LOGO：</span> <div class="updloads"><upladimg v-on:srclistchage="srclistchage"></upladimg></div>
    </div>
    <div class="Logo">
      <span class="organization">营业执照：</span> <div class="updloads"><imagess></imagess></div>
    </div>
    <div class="introduction">
      <span class="organization">服务介绍：</span>
      <el-input type="textarea" :autosize="{ minRows: 2, maxRows: 2}" placeholder="请输入内容" class="textareas" v-model="textareas">
      </el-input>
    </div>
...
import imagess from "../../common/image.vue";
    ...
    modification: function() {
      ...
      this.$http
        .post(
          ...
          {
            ppsp_name: this.name,
            real_name_leader: this.names,
            reg_id: id,
            reg_Prov: this.ProvObj.prov,
            reg_ciry: this.ProvObj.ciry,
            sex: this.radio,
            ppsp_hot_line: this.phone,
            ppsp_introduce: this.textareas,
            ppsp_logo_1: this.ppsp_logo_url
          },
          {
            headers: {
