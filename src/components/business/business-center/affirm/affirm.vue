<template>
            ...
            <div class="order-card">
              ...
              <li class="order-card-li" v-show="select">
                  ...
                  <div class="order-card-li-center">
                    ...
                    <p>高科新农值保一队</p>
                      <div class="feelot">
                        <el-button type="primary" class="select" @click="centerDialogVisible=true">确认完成</el-button>  <el-button type="primary" class="select cancel" @click="checkojb">查看订单</el-button>
                      </div>
                  </div>
              </li>
              <!-- 横版 -->
                ...
                <!-- 横版 -->
                 <div class="across">
                   ...
                   <div class="order-sper-tops">
                     ...
                     <el-button type="primary" class="primar jigouss" @click="centerDialogVisible=true">确认完成</el-button>
                   </div>
  ...
  <div class="countersign">
    <div class="countersign-left">
      <img src="../../../../assets/确认.png" alt="">
    </div>
    <div class="countersign-right">
      <p>请确认值保机构是否已经完成订单作业</p>
      <input type="text" placeholder="请输入未完成原因">
    </div>
  </div>
