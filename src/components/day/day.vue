<template>
<div class="daystian">
   <iframe allowtransparency="true" frameborder="0" width="301" height="100" scrolling="no" src="//tianqi.2345.com/plugin/widget/index.htm?s=2&z=1&t=1&v=0&d=1&bd=1&k=c0c0c0&f=000000&ltf=009944&htf=cc0000&q=1&e=1&a=1&c=59493&w=257&h=100&align=center"></iframe>
  <div class="calendar">
...
export default {
    ...
    methods: {
       ...
       // 选中日期
        select(k1, k2, e) {
          var datanubur =e.toElement.innerText-0;
          if(!isNaN(datanubur)){
              console.log(datanubur);
          }
        },
        changeYear(){
            if(this.yearsShow){
...
.calendar td.week[data-v-101a299c]{
  color:green;
  font-size: 16px;
}
</style>
